...
<div style="display:flex; align-items:center; justify-content:space-between;
    ...
    <div>
        <div style="font-family:'Plus Jakarta Sans',sans-serif; font-weight:800;
                    font-size:20px; color:var(--blue-900);">📄 My Report Card</div>
        <div style="font-size:13px; color:var(--gray-400); margin-top:4px;">
            View your term results and performance
        </div>
    </div>
    @if($scores->count() > 0)
        <button onclick="window.print()" class="module-btn outline">🖨️ Print</button>
    @endif
</div>

{{-- Term selector --}}
<div class="card" style="margin-bottom:24px;">
    <form method="GET" action="{{ route('student.report-card') }}"
        ...
        <button type="submit" class="module-btn" style="margin-bottom:0;">
            📄 View Report
        </button>
    </form>
</div>
        ...
        <div class="card" style="margin-bottom:20px; padding:28px;">
            ...
            <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:14px;"
                ...
                <div style="background:var(--blue-50); border:1px solid var(--blue-100);
                    ...
                    <div style="font-size:11.5px; color:var(--gray-400); margin-bottom:6px;">
                        Subjects
                    </div>
                    <div style="font-family:'Plus Jakarta Sans',sans-serif; font-weight:800;
...
@elseif($selectedTerm && $selectedSession)
    <div class="card">
        <div class="empty-state">
            ...
            <p style="font-size:12.5px; margin-top:6px; color:var(--gray-400);">
                Check back after your teachers have entered scores.
            </p>
        </div>
    </div>
@endif
...
<style>
    ...
    @media print {
        .sidebar, .topbar, form, .module-btn { display:none !important; }
